...
# USAGE : 터미널에 붙여넣어서 돌리면 됩니다 !
# python ./FaceRecognitionDL/1_extract_train.py --dataset ./FaceRecognitionDL/dataset --embeddings ./FaceRecognitionDL/output/embeddings.pickle \
#        --detector ./FaceRecognitionDL/face_detection_model --embedding_model ./FaceRecognitionDL/face_detection_model/openface_nn4.small2.v1.t7 \
