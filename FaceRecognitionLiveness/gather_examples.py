# USAGE
# python ./FaceRecognitionLiveness/gather_examples.py --input videos/real.mov --output dataset/real --detector face_detector --skip 1
# python ./FaceRecognitionLiveness/gather_examples.py --input videos/fake.mp4 --output dataset/fake --detector face_detector --skip 4
